...
class Step1GeneratorConfig(Config):
    IN_HEIGHT = 1
    IN_WIDTH = 1
    IN_CHANNEL = 100
    ...
    TRAN_CONV_LAYER_1_IN_CHANNEL = 32
    TRAN_CONV_LAYER_2_IN_CHANNEL = 16
    TRAN_CONV_LAYER_3_IN_CHANNEL = 4
